  ...
  {images[questionId] && Array.from(images[questionId]).map((file, index) => (
    <img
      ...
      style={{
        ...
        height: '50px',
        position: 'absolute',
        left: `${index * 15}px`, // Adjust this to control the overlap amount
        zIndex: index, // Stack images with increasing z-index
        objectFit: 'cover',
        borderRadius: '5px', // Optional: Add rounded corners to the images
