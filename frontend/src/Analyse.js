...
// //     const responseObj = filteredAudits.find((audit) => audit.question === questionId);
// //     return responseObj ? responseObj.response.response : 'No response';
// //   };
...
//       {/* Render SummaryCharts only if an audit ID is selected */}
//       {selectedAuditId && (
//         <SummaryCharts
