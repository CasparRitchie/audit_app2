...
//         <Route path="/create" element={<><AuditHeader /><AuditDetail /></>} />  {/* Create new audit */}
//         <Route path="/view" element={<ViewAudits />} />  {/* View existing audits */}
//         <Route path="/edit" element={<EditAudit />} />  {/* Edit existing audit */}
//       </Routes>
//     </Router>
//   );
// }
