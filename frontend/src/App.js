    ...
    <Router>
      <div className="container-fluid mt-4">
        ...
        <div className="row">
          ...
          <div className={isSidebarOpen ? "col-md-9" : "col-md-12"}>
            <nav className="navbar navbar-expand-lg navbar-light bg-light mb-4">
              <Link className="navbar-brand" to="/">Audit App</Link> {/* This takes us to the home page */}
              ...
              <div className="collapse navbar-collapse" id="navbarNav">
                <ul className="navbar-nav mr-auto">
                  ...
                  <li className="nav-item">
                    <Link className="nav-link" to="/edit">Editer Audit (en construction)</Link>
                  </li>
                  <li className="nav-item">
                    <Link className="nav-link" to="/analyse">Analyse Audits</Link> {/* New Analyse button */}
                  </li>
                </ul>
              </div>
            </nav>
