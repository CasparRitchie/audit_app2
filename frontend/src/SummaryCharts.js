...
// //     const newQueue = [
// //       { url: `/api/chart/cpcnc/${cpcncData.C}/${cpcncData.PC}/${cpcncData.NC}?t=${timestamp}`, setter: setCpcncChartUrl },
// //       { url: `/api/chart/okko/${okkoData.OK}/${okkoData.KO}?t=${timestamp}`, setter: setOkkoChartUrl },
// //       { url: `/api/chart/temperature/${temperatureData.over63}/${temperatureData.under63}?t=${timestamp}`, setter: setTemperatureChartUrl }
// //     ];
